...
while 1:
    ...
    needed_symbols.add(("htons", 1))
    needed_symbols.add(("htonl", 1))
    needed_symbols.add(("ctime_r", 1))
    needed_symbols.add(("roundf", 1))
    needed_symbols.add(("__addsf3", 1))
    needed_symbols.add(("cfsetispeed", 1))
    # Symbols needed for mgcamd  							
    needed_symbols.add(("DES_ecb3_encrypt", 1)) 		
    needed_symbols.add(("idea_cbc_encrypt", 1)) 		
    needed_symbols.add(("idea_ecb_encrypt", 1)) 		
    needed_symbols.add(("idea_set_encrypt_key", 1))	
    needed_symbols.add(("SHA1", 1)) 						
    needed_symbols.add(("SHA1_Init", 1))  				
    needed_symbols.add(("SHA1_Update", 1))
    # Symbols needed for dropbear
    needed_symbols.add(("getpass", 1))
    # Symbols needed for movieplayer DM500 maxvar
    needed_symbols.add(("curl_easy_setopt", 1))							 				
	...
	try:
        	...
        	if not is_weak:
            	    debug(DEBUG_NORMAL, "No library provides non-weak ",symbol)
    	    else:
