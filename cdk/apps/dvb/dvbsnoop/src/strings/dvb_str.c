/*
$Id: dvb_str.c,v 1.79 2008/08/30 17:31:26 obi Exp $
...
$Log: dvb_str.c,v $
Revision 1.79  2008/08/30 17:31:26  obi
automatically generate string tables from data available on dvb.org
