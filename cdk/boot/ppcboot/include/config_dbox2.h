...
#define	CFG_PROMPT	"dbox2-ppcboot> "		/* Monitor Command Prompt	*/
...
#ifdef	DEBUG
#define	CFG_MONITOR_LEN		(512 << 10)	/* Reserve 256 kB for Monitor	*/
#else
...
#define FLASH_BASE1_PRELIM	0x10000000	/* FLASH bank #0	*/
