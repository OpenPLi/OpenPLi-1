...
SRC_URI = "http://www.busybox.net/downloads/busybox-${PV}.tar.gz \
	   ...
	   file://keymap_endianess.patch;patch=1 \
           file://wget-useragent.diff;patch=1 \
           file://mount.patch;patch=1 \
           file://defconfig \
           file://busybox-cron \
	   file://busybox-httpd \
	   file://busybox-udhcpd \
	   ...
	   file://mount.busybox \
	   file://umount.busybox \
	   file://nfsroot.patch;patch=1 \
	   file://stop_daemon_unionfs.patch;patch=1 \
	   "
...
PACKAGES =+ "${PN}-httpd ${PN}-udhcpd ${PN}-cron"

FILES_${PN}-httpd = "${sysconfdir}/init.d/busybox-httpd /srv/www"
FILES_${PN}-udhcpd = "${sysconfdir}/init.d/busybox-udhcpd"
FILES_${PN}-cron = "${sysconfdir}/init.d/busybox-cron ${sysconfdir}/cron"

FILES_${PN} += " ${datadir}/udhcpc"

INITSCRIPT_PACKAGES = "${PN} ${PN}-httpd ${PN}-udhcpd ${PN}-cron"
