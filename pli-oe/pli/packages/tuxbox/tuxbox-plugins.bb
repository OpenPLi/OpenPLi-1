...
FILES_tuxbox-plugin-tuxtxt = "/usr/share/fonts/tuxtxt.ttf /usr/share/fonts/tuxtxt.otb /etc/tuxbox/tuxtxt"
...
EXTRA_OECONF = "--with-target=native --without-debug --with-boxtype=${MACHINE}"
